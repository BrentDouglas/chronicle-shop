 ...
 */
package io.machinecode.shop.cart.support;
...
public class TestCartListener implements CartListener {
  ...
  @Override
  public void onCartProductAddedEvent(final CartProductAddedEvent event) {
    events.add(event.deepCopy());
  }

  @Override
  public void onCartProductUpdatedEvent(final CartProductUpdatedEvent event) {
    events.add(event.deepCopy());
  }

  @Override
  public void onCartProductRemovedEvent(final CartProductRemovedEvent event) {
    events.add(event.deepCopy());
  }

  @Override
  public void onCartTotalEvent(final CartTotalEvent event) {
    events.add(event.deepCopy());
  }

  @Override
  public void onCartErrorEvent(final CartErrorEvent event) {
    events.add(event.deepCopy());
  }
}
