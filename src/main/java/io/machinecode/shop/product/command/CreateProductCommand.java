...
public class CreateProductCommand extends SelfDescribingMarshallable {
  private long id;
  ...
  public CreateProductCommand(final long id, final double price, final CharSequence description) {
    this.id = id;
    this.price = price;
