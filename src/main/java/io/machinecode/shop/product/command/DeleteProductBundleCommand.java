...
public class DeleteProductBundleCommand extends SelfDescribingMarshallable {
  private long id;

  public DeleteProductBundleCommand() {}

  public DeleteProductBundleCommand(final long id) {
    this.id = id;
  }
