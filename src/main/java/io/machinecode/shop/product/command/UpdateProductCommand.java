...
public class UpdateProductCommand extends SelfDescribingMarshallable {
  private long id;
  ...
  public UpdateProductCommand(final long id, final double price, final CharSequence description) {
    this.id = id;
    this.price = price;
