 ...
 */
package io.machinecode.shop.product.api;
...
public interface ProductDispatcher {
  ...
  void sendCreateProductCommand(final CreateProductCommand command);

  void sendUpdateProductCommand(final UpdateProductCommand command);

  void sendDeleteProductCommand(final DeleteProductCommand command);

  void sendCreateProductBundleCommand(final CreateProductBundleCommand command);

  void sendDeleteProductBundleCommand(final DeleteProductBundleCommand command);
}
