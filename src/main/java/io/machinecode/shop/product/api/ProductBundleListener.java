...
public interface ProductBundleListener {
  ...
  void onProductBundleCreated(final ProductBundleCreatedEvent event);

  void onProductBundleDeleted(final ProductBundleDeletedEvent event);

  void onProductBundleError(final ProductBundleErrorEvent event);
}
