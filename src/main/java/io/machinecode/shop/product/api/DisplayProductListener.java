...
public interface DisplayProductListener {

  void onDisplayProductCreated(final DisplayProductCreatedEvent event);

  void onDisplayProductUpdated(final DisplayProductUpdatedEvent event);

  void onDisplayProductDeleted(final DisplayProductDeletedEvent event);
}
