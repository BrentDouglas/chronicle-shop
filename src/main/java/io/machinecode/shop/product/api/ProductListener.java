...
public interface ProductListener {
  ...
  void onProductCreated(final ProductCreatedEvent event);

  void onProductUpdated(final ProductUpdatedEvent event);

  void onProductDeleted(final ProductDeletedEvent event);

  void onProductError(final ProductErrorEvent event);
}
