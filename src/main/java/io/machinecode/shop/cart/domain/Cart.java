...
public interface Cart {
  ...
  @Array(length = MAX_PRODUCTS_PER_CART)
  CartProductId getProductIdAt(final int index);

  void setProductIdAt(final int index, final CartProductId id);
}
