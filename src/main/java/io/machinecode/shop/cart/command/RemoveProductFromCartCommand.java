...
public class RemoveProductFromCartCommand extends SelfDescribingMarshallable {
  private long id;
  private DisplayProductId displayProductId;

  public RemoveProductFromCartCommand() {}

  public RemoveProductFromCartCommand(final long id, final DisplayProductId displayProductId) {
    this.id = id;
