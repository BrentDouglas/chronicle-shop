 ...
 */
package io.machinecode.shop.cart.command;

import io.machinecode.shop.product.model.DisplayProductId;
import net.openhft.chronicle.wire.SelfDescribingMarshallable;

/** @author <a href="mailto:brent.n.douglas@gmail.com">Brent Douglas</a> */
public class UpdateProductQuantityInCartCommand extends SelfDescribingMarshallable {
  private long id;
  private DisplayProductId displayProductId;
  private int quantity;

  public UpdateProductQuantityInCartCommand() {}

  public UpdateProductQuantityInCartCommand(
      final long id, final DisplayProductId displayProductId, final int quantity) {
    this.id = id;
