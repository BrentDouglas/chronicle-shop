...
public interface CartDispatcher {
  ...
  void sendAddProductToCartCommand(final AddProductToCartCommand command);

  void sendUpdateProductQuantityInCartCommand(final UpdateProductQuantityInCartCommand command);

  void sendRemoveProductFromCartCommand(final RemoveProductFromCartCommand command);

  void sendCalculateTotalForCartCommand(final CalculateTotalForCartCommand command);
}
